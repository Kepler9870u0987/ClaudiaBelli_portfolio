...
export const Books = () => {
  return (
    <PageTransition>
      <section id="libri" className="py-40 px-12 min-h-screen bg-brand-cream overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <SectionHeading>La mia Biblioteca</SectionHeading>
          
          <div className="mb-20 p-8 border-l-4 border-brand-clay bg-brand-paper shadow-sm rounded-r-2xl">
          ...
          <div className="grid grid-cols-1 gap-24">
            {BOOKS.map((book, idx) => (
              <div key={book.id} className="relative group">
                <div className="absolute -left-12 top-0 text-[120px] font-serif italic opacity-[0.03] select-none pointer-events-none">
                  0{idx + 1}
                </div>
                <BookCard book={book} />
              </div>
